...
<div class="container-fluid">
	...
	<form action="" id="manage-check">
		...
		<div class="form-group">
			...
			<input type="date" name="date_in" id="date_in" class="form-control" value="<?php echo isset($meta['date_in']) ? date("Y-m-d",strtotime($meta['date_in'])): date("Y-m-d") ?>" required readonly>
		</div>
		<div class="form-group">
