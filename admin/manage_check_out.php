...
<div class="container-fluid">
	...
	<p><b>Topic Category : </b><?php echo $cat['name'] ?></p>
	<p><b>Base Price : </b><?php echo '$'.number_format($cat['price'],2) ?></p>
	<p><b>Reference no : </b><?php echo $ref_no ?></p>
	<p><b>Name : </b><?php echo $name ?></p>
	<p><b>Contact no : </b><?php echo $contact_no ?></p>
	<p><b>Appointment Date/Time : </b><?php echo date("M d, Y h:i A",strtotime($date_in)) ?></p>
		...
		<div class="row">
			<?php if(isset($_GET['checkout']) && $status != 2): ?>
				<div class="col-md-3">
					<button type="button" class="btn btn-primary" id="checkout">Apply</button>
				</div>
				<div class="col-md-3">
